                ...
                <div class="navbar-vertical">
                    ...
                    <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                        <ul class="navbar-nav flex-column" id="sideNavbar">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link <?php echo(basename($_SERVER["SCRIPT_FILENAME"])=="index.php")?"active":""; ?> " href="index.php">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link <?php echo(basename($_SERVER["SCRIPT_FILENAME"])=="products.php")?"active":""; ?>" href="products.php">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link <?php echo(basename($_SERVER["SCRIPT_FILENAME"])=="categories.php")?"active":""; ?>" href="categories.php">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="navCategoriesOrders" class="collapse " data-bs-parent="#sideNavbar">
                                    <ul class="nav flex-column">
                                        <li class="nav-item ">
                                            <a class="nav-link <?php echo(basename($_SERVER["SCRIPT_FILENAME"])=="order-list.php")?"active":""; ?>" href="order-list.php">
                                                List
                                            </a>
                                        </li>
                                        <!-- Nav item -->
                                        <li class="nav-item ">
                                            <a class="nav-link <?php echo(basename($_SERVER["SCRIPT_FILENAME"])=="order-single.php")?"active":""; ?>" href="order-single.php">
                                                Single
                            ...
                            <li class="nav-item ">
                                <a class="nav-link <?php echo(basename($_SERVER["SCRIPT_FILENAME"])=="vendor-grid.php")?"active":""; ?>" href="vendor-grid.php">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link <?php echo(basename($_SERVER["SCRIPT_FILENAME"])=="customers.php")?"active":""; ?>" href="customers.php">
                                    <div class="d-flex align-items-center">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link <?php echo(basename($_SERVER["SCRIPT_FILENAME"])=="reviews.php")?"active":""; ?>" href="reviews.php">
                                    <div class="d-flex align-items-center">
