...
<!-- Mirrored from freshcart.codescandy.com/pages/signup.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:40 GMT -->
          ...
          <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
            ...
            <form action="signup.php" method="Post">
              <div class="row g-3">
                <!-- col -->
                <div class="col">
                  <!-- input --><input type="text" class="form-control" name="Firstname" placeholder="First name"
                    aria-label="First name" required>
                </div>
                <div class="col">
                  <!-- input --><input type="text" class="form-control" name="Lastname" placeholder="Last name"
                    aria-label="Last name" required>
                </div>
                <div class="col-12">

                  <!-- input --><input type="email" class="form-control" id="inputEmail4" name="Email"
                    placeholder="Email" required>
                </div>
                <div class="col-12">

                  <div class="password-field position-relative">
                    <input type="password" id="fakePassword" name="PassWord" placeholder="Enter Password"
