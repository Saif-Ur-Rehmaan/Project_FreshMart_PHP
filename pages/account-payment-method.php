...
<!-- Mirrored from freshcart.codescandy.com/pages/account-payment-method.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:40 GMT -->
<head>
          ...
          <div class="pt-10 pe-lg-10">
            ...
            <ul class="nav flex-column nav-pills nav-pills-dark">
              ...
              <li class="nav-item">
                ...
                <!-- nav item -->
              <li class="nav-item">
                <a class="nav-link " href="account-settings.php"><i
                    class="feather-icon icon-settings me-2"></i>Settings</a>
              </li>
                <!-- nav item -->
              <li class="nav-item">
                <a class="nav-link " href="account-address.php"><i
                    class="feather-icon icon-map-pin me-2"></i>Address</a>
              </li>
                <!-- nav item -->
              <li class="nav-item">
                <a class="nav-link active" href="account-payment-method.php"><i
  ...
  <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasAccount" aria-labelledby="offcanvasAccountLabel">
    ...
    <div class="offcanvas-body">
      <ul class="nav flex-column nav-pills nav-pills-dark">
        ...
        <!-- nav item -->
        <li class="nav-item">
          <a class="nav-link " href="account-settings.php"><i class="feather-icon icon-settings me-2"></i>Settings</a>
        </li>
        <!-- nav item -->
        <li class="nav-item">
                ...
                <div class="d-inline-flex">
                  <div class="form-check me-2">
                    ...
                    <label class="form-check-label" for="paymentRadioOne"><img
                        src="../assets/images/american-express.svg" alt=""></label>
                  </div>
                  <!-- Radio button -->
                  <div class="form-check me-2">
                    ...
                    <label class="form-check-label" for="paymentRadioTwo"><img
                        src="../assets/images/mastercard.svg" alt=""></label>
                  </div>

                  <!-- Radio button -->
                  <div class="form-check">
                    <input type="radio" id="paymentRadioFour" name="paymentRadioOne" class="form-check-input" />
                    <label class="form-check-label" for="paymentRadioFour"><img src="../assets/images/visa.svg"
                        alt=""></label>
                  </div>
                </div>
              </div>
...
<!-- Mirrored from freshcart.codescandy.com/pages/account-payment-method.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:42 GMT -->
</html>