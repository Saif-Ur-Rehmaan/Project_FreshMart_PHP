...
<!-- Mirrored from freshcart.codescandy.com/pages/store-single.php/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:32 GMT -->
<head>
          ...
          <div class="col-md-2 col-xxl-1 text-end d-none d-lg-block">
            ...
            <div class="list-inline">
              <div class="list-inline-item">
                ...
                <a href="shop-wishlist.phpon-relative">
    ...
    <div class="container px-0 px-md-3">
      <div class="dropdown me-3 d-none d-lg-block">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
          <li><a class="dropdown-item" href="shop-grid.php/li>
          <li><a class="dropdown-item" href="shop-grid.phpi>
          <li><a class="dropdown-item" href="shop-grid.php/li>
          <li><a class="dropdown-item" href="shop-grid.php</li>
          <li><a class="dropdown-item" href="shop-grid.php</a></li>
          <li><a class="dropdown-item" href="shop-grid.phpi>
          <li><a class="dropdown-item" href="shop-grid.php</li>
        </ul>
      </div>
      <div class="offcanvas offcanvas-start p-4 p-lg-0" id="navbar-default">
        <div class="d-flex justify-content-between align-items-center mb-2 d-block d-lg-none">
          <a href="../index.phpes/logo/freshcart-logo.svg"
          ...
          <ul class="navbar-nav align-items-center ">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="index-2.php
                <li><a class="dropdown-item" href="index-3.php
                <li><a class="dropdown-item" href="index-4.php
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="shop-grid.phpli>
                <li><a class="dropdown-item" href="shop-grid-3-column.php
                </li>
                <li><a class="dropdown-item" href="shop-list.phpli>
                <li><a class="dropdown-item" href="shop-filter.php
                <li><a class="dropdown-item" href="shop-fullwidth.php
                <li><a class="dropdown-item" href="shop-single.php
                <li><a class="dropdown-item" href="shop-single-2.php
                      class="badge bg-light-info text-dark-info ms-1">New</span></a></li>
                <li><a class="dropdown-item" href="shop-wishlist.php
                <li><a class="dropdown-item" href="shop-cart.php
                <li><a class="dropdown-item" href="shop-checkout.php
              </ul>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="store-list.php
                <li><a class="dropdown-item" href="store-grid.php
                <li><a class="dropdown-item" href="store-single.php
              </ul>
            </li>
              ...
              <div class=" dropdown-menu pb-0">
                <div class="row p-2 p-lg-4">
                  <div class="col-lg-3 col-6 mb-4 mb-lg-0">
                    ...
                    <a class="dropdown-item" href="shop-grid.php
                    <a class="dropdown-item" href="shop-grid.php
                    <a class="dropdown-item" href="shop-grid.php
                    <a class="dropdown-item" href="shop-grid.php
                    <a class="dropdown-item" href="shop-grid.php
                  ...
                  <div class="col-lg-3 col-6 mb-4 mb-lg-0">
                    ...
                    <a class="dropdown-item" href="shop-grid.php
                    <a class="dropdown-item" href="shop-grid.phpa>
                    <a class="dropdown-item" href="shop-grid.php
                    <a class="dropdown-item" href="shop-grid.phpa>
                    <a class="dropdown-item" href="shop-grid.php
                    <a class="dropdown-item" href="shop-grid.php
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="blog-single.php
                <li><a class="dropdown-item" href="blog-category.php
                <li><a class="dropdown-item" href="about.php
                <li><a class="dropdown-item" href="404error.php
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="forgot-password.php
                <li class="dropdown-submenu dropend">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item" href="account-address.php
                    <li><a class="dropdown-item" href="account-payment-method.php
                    </li>
                    <li><a class="dropdown-item" href="account-notification.php
                  </ul>
                </li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="dropdown-submenu ">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="shop-grid.php
                    <li><a class="dropdown-item" href="shop-grid.php
                    <li> <a class="dropdown-item" href="shop-grid.php
                    <li><a class="dropdown-item" href="shop-grid.php
                    <li><a class="dropdown-item" href="shop-grid.php
          ...
          <div class="col-12 col-lg-3 col-md-4 mb-4 mb-md-0">
            <div class="d-flex flex-column">
              <div>
                ...
                <!-- img -->
                <img
                  src="../assets/images/stores-logo-1.svg"
                  alt=""
          ...
          <div class="col-12 col-lg-9 col-md-8">
            ...
            >
              ...
              <div class="py-4">
                <!-- img -->
                <img
                  src="../assets/images/store-graphics.svg"
                  alt=""
                  class="img-fluid"
                />
              </div>
        ...
        <div class="row g-4">
          ...
          <div class="col-6 col-sm-6 col-md-3">
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item mb-2"><a href="shop-checkout.phpeckout</a></li>
            </ul>
          </div>
          <div class="col-6 col-sm-6 col-md-3">
