...
<!-- Mirrored from freshcart.codescandy.com/pages/shop-fullwidth.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:24 GMT -->
<head>
          ...
          <ul class="navbar-nav align-items-center ">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="shop-grid-3-column.php">Shop Grid - 3 column</a>
                </li>
        ...
        <div class="col-lg-12">
          ...
          <div class="row g-4 row-cols-lg-5 row-cols-2 row-cols-md-3 mt-2">
                ...
                <div class="card-body">
                  ...
                  <div class="text-center position-relative ">
                    ...
                    <a href="shop-single.php">
                      <!-- img --><img src="../assets/images/product-img-1.jpg"
            ...
            <div class="col">
              ...
              <div class="card card-product">
                <div class="card-body">
                  <div class="text-center position-relative"> <a href="shop-single.php">
                      <!-- img --><img src="../assets/images/product-img-2.jpg"
                        alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                    <!-- action btn -->
                    <div class="card-product-action">
                      <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                  ...
                  <h2 class="fs-6"><a href="shop-single.php" class="text-inherit text-decoration-none">NutriChoice Digestive </a>
                  </h2>
                  <!-- rating -->
            ...
            <div class="col">
              ...
              <div class="card card-product">
                <div class="card-body">
                  <div class="text-center position-relative"> <a href="shop-single.php">
                      <!-- img --><img src="../assets/images/product-img-3.jpg"
                        alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                    <!-- action btn -->
                    <div class="card-product-action">
                      <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                  ...
                  <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Bakery &
                        Biscuits</small></a></div>
                  <h2 class="fs-6"><a href="shop-single.php" class="text-inherit text-decoration-none">Cadbury 5 Star Chocolate</a>
                  </h2>
                  <!-- rating -->
                  <div class="text-warning">
            ...
            <div class="col">
              ...
              <div class="card card-product">
                <div class="card-body">
                  <div class="text-center position-relative"> <a href="shop-single.php">
                      <!-- img --><img src="../assets/images/product-img-4.jpg"
                        alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                    <!-- action btn -->
                    <div class="card-product-action">
                      <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
            ...
            <div class="col">
              ...
              <div class="card card-product">
                <div class="card-body">
                  <div class="text-center position-relative"> <a href="shop-single.php">
                      <!-- img --><img src="../assets/images/product-img-5.jpg"
                        alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                    <!-- action btn -->
                    <div class="card-product-action">
                      <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                  ...
                  <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Instant
                        Food</small></a></div>
                  <h2 class="fs-6"><a href="shop-single.php" class="text-inherit text-decoration-none">Salted Instant Popcorn </a>
                  </h2>
                  <!-- rating -->
                  <div class="text-warning">
              ...
              <div class="card card-product">
                <div class="card-body">
                  ...
                  <div class="text-center position-relative ">
                    ...
                    <a href="shop-single.php">
                      <!-- img --><img src="../assets/images/product-img-6.jpg"
                        alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                    <!-- action btn -->
                    <div class="card-product-action">
                      <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                  ...
                  <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Dairy, Bread
                        & Eggs</small></a></div>
                  <h2 class="fs-6"><a href="shop-single.php" class="text-inherit text-decoration-none">Blueberry Greek Yogurt</a>
                  </h2>
                  <div>
            ...
            <div class="col">
              ...
              <div class="card card-product">
                <div class="card-body">
                  <div class="text-center position-relative"> <a href="shop-single.php">
                      <!-- img --><img src="../assets/images/product-img-7.jpg"
                        alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                    <!-- action btn -->
                    <div class="card-product-action">
                      <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                  ...
                  <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Dairy, Bread
                        & Eggs</small></a></div>
                  <h2 class="fs-6"><a href="shop-single.php" class="text-inherit text-decoration-none">Britannia Cheese Slices</a>
                  </h2>
                  <!-- rating -->
                  <div class="text-warning">
            ...
            <div class="col">
              ...
              <div class="card card-product">
                <div class="card-body">
                  <div class="text-center position-relative"> <a href="shop-single.php">
                      <!-- img --><img src="../assets/images/product-img-8.jpg"
                        alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                    <!-- action btn -->
                    <div class="card-product-action">
                      <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                  ...
                  <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Instant
                        Food</small></a></div>
                  <h2 class="fs-6"><a href="shop-single.php" class="text-inherit text-decoration-none">Kellogg's Original Cereals</a>
                  </h2>
                  <!-- rating -->
                  <div class="text-warning">
            ...
            <div class="col">
              ...
              <div class="card card-product">
                <div class="card-body">
                  <div class="text-center position-relative"> <a href="shop-single.php">
                      <!-- img --><img src="../assets/images/product-img-9.jpg"
                        alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                    <!-- action btn -->
                    <div class="card-product-action">
                      <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                  ...
                  <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Snack &
                        Munchies</small></a></div>
                  <h2 class="fs-6"><a href="shop-single.php" class="text-inherit text-decoration-none">Slurrp Millet Chocolate </a>
                  </h2>
                  <!-- rating -->
                  <div class="text-warning">
            ...
            <div class="col">
              ...
              <div class="card card-product">
                <div class="card-body">
                  <div class="text-center position-relative"> <a href="shop-single.php">
                      <!-- img --><img src="../assets/images/product-img-10.jpg"
                        alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
                    <!-- action btn -->
                    <div class="card-product-action">
                      <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i
                  ...
                  <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Dairy, Bread
                        & Eggs</small></a></div>
                  <h2 class="fs-6"><a href="shop-single.php" class="text-inherit text-decoration-none">Amul Butter - 500 g</a></h2>
                  <!-- rating -->
                  <div class="text-warning">
