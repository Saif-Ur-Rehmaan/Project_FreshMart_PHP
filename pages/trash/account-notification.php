...
<!-- Mirrored from freshcart.codescandy.com/pages/account-notification.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:42 GMT -->
<head>
        ...
        <div class="col-lg-3 col-md-4 col-12 border-end  d-none d-md-block">
          <div class="pt-10 pe-lg-10">
            ...
            <ul class="nav flex-column nav-pills nav-pills-dark">
              ...
              <!-- nav item -->
              <li class="nav-item">
                <a class="nav-link active" href="account-notification.php"><i
