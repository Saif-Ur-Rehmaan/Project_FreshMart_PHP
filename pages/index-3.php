...
<!-- Mirrored from freshcart.codescandy.com/pages/index-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:11 GMT -->
<head>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" >
            ...
            <li><a class="dropdown-item" href="index-3.php">Home 3</a></li>
                   <li><a class="dropdown-item" href="index-4.php">Home 4 <span class="badge bg-light-info text-dark-info ms-1">New</span></a></li>
...
<li><a class="dropdown-item" href="shop-single-2.php">Shop Single v2<span class="badge bg-light-info text-dark-info ms-1">New</span></a></li>
...
<div>
 ...
 <!-- text -->
              <div class="mt-4">
                <h5 class="fs-6 mb-0"> <a href="shop-grid.php" class="text-inherit">Dairy, Bread & Eggs</a></h5>
              </div>
 ...
 <!-- img -->
              ...
              <div class="mt-4">
                 <!-- text -->
                <h5 class="fs-6 mb-0"> <a href="shop-grid.php" class="text-inherit">Fruits & Vegetables</a></h5>
              </div>
            ...
            <div class="text-center mb-10">
              ...
              <a href="#"><img src="../assets/images/snack-munchies.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
                <h5 class="fs-6 mb-0"> <a href="shop-grid.php" class="text-inherit">Snack & Munchies</a></h5>
              </div>
 ...
 <!-- img -->
              <a href="#"><img src="../assets/images/bakery-biscuits.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
                <h5 class="fs-6 mb-0"> <a href="shop-grid.php" class="text-inherit">Bakery & Biscuits</a></h5>
              </div>
            ...
            <div class="text-center mb-10">
              ...
              <a href="#"><img src="../assets/images/instant-food.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
                <h5 class="fs-6 mb-0"> <a href="shop-grid.php" class="text-inherit">Instant Food</a></h5>
              </div>
            ...
            <div class="text-center mb-10">
              ...
              <a href="#"><img src="../assets/images/tea-coffee-drinks.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
                <h5 class="fs-6 mb-0"> <a href="shop-grid.php" class="text-inherit">Tea, Coffee & Drinks</a></h5>
              </div>
            ...
            <div class="text-center mb-10">
              ...
              <a href="#"><img src="../assets/images/cold-drinks-juices.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
                <h5 class="fs-6 mb-0"> <a href="shop-grid.php" class="text-inherit">Cold Drinks & Juices</a></h5>
              </div>
            ...
            <div class="text-center mb-10">
              ...
              <a href="#"><img src="../assets/images/chicken-meat-fish.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
                <h5 class="fs-6 mb-0"> <a href="shop-grid.php" class="text-inherit">Chicken, Meat & Fish</a></h5>
              </div>
            ...
            <div class="text-center mb-10">
              ...
              <a href="#"><img src="../assets/images/baby-care.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
                <h5 class="fs-6 mb-0"> <a href="shop-grid.php" class="text-inherit">Baby Care</a></h5>
              </div>
            ...
            <div class="text-center mb-10">
              ...
              <a href="#"><img src="../assets/images/cleaning-essentials.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- img -->
              <div class="mt-4">
                <h5 class="fs-6 mb-0"> <a href="shop-grid.php" class="text-inherit">Cleaning Essentials</a></h5>
              </div>
 ...
 <!-- img -->
              <a href="#"><img src="../assets/images/pet-care.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
                <h5 class="fs-6 mb-0"> <a href="shop-grid.php" class="text-inherit">Pet Care</a></h5>
              </div>
            </div>
          </div>
           <!-- col -->
 ...
 <!-- img -->
              <a href="#"><img src="../assets/images/atta-rice-dal.png" alt=""
                  class="card-image rounded-circle"></a>
                   <!-- text -->
              <div class="mt-4">
                <h5 class="fs-6 mb-0"><a href="shop-grid.php" class="text-inherit">Atta, Rice & Dal</a></h5>
              </div>
...
<!-- Mirrored from freshcart.codescandy.com/pages/index-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:18 GMT -->
</html>