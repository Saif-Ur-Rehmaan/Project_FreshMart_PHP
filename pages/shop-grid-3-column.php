...
<!-- Mirrored from freshcart.codescandy.com/pages/shop-grid-3-column.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:24 GMT -->
<head>
        ...
        <section class="col-lg-9 col-md-12">
          ...
          <div class="d-lg-flex justify-content-between align-items-center">
            ...
            <div class="d-md-flex justify-content-between align-items-center">
              ...
              <a href="shop-grid.php" class=" me-3 text-muted"><i class="bi bi-grid"></i></a>
              <a href="shop-grid-3-column.php" class="me-3 active"><i class="bi bi-grid-3x3-gap"></i></a>
              </div>
          ...
          <div class="row g-4 row-cols-xl-3 row-cols-lg-3 row-cols-2 row-cols-md-2 mt-2">
            ...
            <div class="col">
              ...
              <div class="card card-product">
                <div class="card-body">
                  <div class="text-center position-relative"> <a href="shop-single.php"><img
