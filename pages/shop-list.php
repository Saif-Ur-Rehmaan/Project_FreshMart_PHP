...
<!-- Mirrored from freshcart.codescandy.com/pages/shop-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:24 GMT -->
<head>
        ...
        <section class="col-lg-9 col-md-12">
          ...
          <div class="d-lg-flex justify-content-between align-items-center">
            ...
            <div class="d-md-flex justify-content-between align-items-center">
              ...
              <a href="shop-list.php" class="active me-3"><i class="bi bi-list-ul"></i></a>
                ...
                <div class="card-body">
                  <div class=" row align-items-center">
                    ...
                    <div class="col-md-8 col-12 flex-grow-1">
                      ...
                      <h2 class="fs-6"><a href="shop-single.php" class="text-inherit text-decoration-none">Haldiram's Sev Bhujia</a>
                      </h2>
                      <div>
                      ...
                      <div class=" mt-6">
                        ...
                        <div class="mt-3">
                          ...
                          <a href="shop-wishlist.php" class="btn btn-icon btn-sm btn-outline-gray-400 text-muted"
                ...
                <div class="card-body">
                  <div class=" row align-items-center">
                    ...
                    <div class="col-md-8 col-12 flex-grow-1">
                      ...
                      <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Bakery &
                            Biscuits</small></a></div>
                      <h2 class="fs-6"><a href="shop-single.php" class="text-inherit text-decoration-none">Cadbury 5 Star
                          Chocolate</a></h2>
                      <div>
                ...
                <div class="card-body">
                  <div class=" row align-items-center">
                    ...
                    <div class="col-md-8 col-12 flex-grow-1">
                      ...
                      <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>Snack &
                            Munchies</small></a></div>
                      <h2 class="fs-6"><a href="shop-single.php" class="text-inherit text-decoration-none">Onion Flavour Potato</a>
                      </h2>
                      <div>
