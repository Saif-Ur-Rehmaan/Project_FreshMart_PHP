...
<!-- Mirrored from freshcart.codescandy.com/pages/store-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:30 GMT -->
<head>
      ...
      <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 g-lg-4">
        ...
        <div class="col">
          ...
          <div class="card flex-row p-8 card-product ">
            <div>
              <!-- img -->
              <img src="../assets/images/stores-logo-1.svg" alt=""
        ...
        <div class="col">
          ...
          <div class="card flex-row p-8 card-product ">
            <div>
              <!-- img -->
              <img src="../assets/images/stores-logo-2.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <!-- content -->
            <div class="ms-6">
        ...
        <div class="col">
          ...
          <div class="card flex-row p-8 card-product ">
            <div>
              <!-- img -->
              <img src="../assets/images/stores-logo-3.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <!-- content -->
            <div class="ms-6">
        ...
        <div class="col">
          ...
          <div class="card flex-row p-8 card-product ">
            <div>
              <!-- img -->
              <img src="../assets/images/stores-logo-4.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <!-- content -->
            <div class="ms-6">
        ...
        <div class="col">
          ...
          <div class="card flex-row p-8 card-product ">
            <div>
              <!-- img -->
              <img src="../assets/images/stores-logo-5.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <!-- content -->
            <div class="ms-6">
        ...
        <div class="col">
          ...
          <div class="card flex-row p-8 card-product ">
            <div>
              <!-- img -->
              <img src="../assets/images/stores-logo-6.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <!-- content -->
            <div class="ms-6">
        ...
        <div class="col">
          ...
          <div class="card flex-row p-8 card-product ">
            <div>
              <!-- img -->
              <img src="../assets/images/stores-logo-7.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <!-- content -->
            <div class="ms-6">
        ...
        <div class="col">
          ...
          <div class="card flex-row p-8 card-product ">
            <div>
              <!-- img -->
              <img src="../assets/images/stores-logo-8.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <!-- content -->
            <div class="ms-6">
        ...
        <div class="col">
          ...
          <div class="card flex-row p-8 card-product ">
            <div>
              <!-- img -->
              <img src="../assets/images/stores-logo-9.svg" alt=""
                class="rounded-circle icon-shape icon-xl"></div>
            <!-- content -->
            <div class="ms-6">
...
<!-- Mirrored from freshcart.codescandy.com/pages/store-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:32 GMT -->
</html>