...
<!-- Mirrored from freshcart.codescandy.com/pages/index-4.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:18 GMT -->
<head>
      ...
      <div class="col-xl-5 col-lg-4 d-flex align-items-center ">
        ...
        <div class="list-inline ms-auto d-lg-block d-none">
          ...
          <div class="list-inline-item">
            ...
            <a href="signin.php" class="btn btn-dark d-none d-xl-block">
              Sign In
            </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="my-10 text-center">
          <img src="../assets/images/delivery-boy.svg" alt="" class="img-fluid">
    ...
    <div class="modal-content  bg-light">
      ...
      <main>
         ...
         <section class="py-lg-16 py-10"
            style="background: url(../assets/images/banner-4.jpg)no-repeat; background-position: center; background-size: cover;">
            <div class="container">
               <!-- row -->
               <div class="row">
                  ...
                  <div class="col-12">
                     <div class="position-relative">
                        <div class="slider-8-columns " id="slider-8-columns">
                           ...
                           <div class="item">
                              <!-- item -->
                              <a href="shop-grid.php" class="text-decoration-none text-inherit">
                                 <!-- card -->
                  ...
                  <div class="row flex-nowrap">
                     <div class="col">
                        <div class="card border-0 card-hover">
                           <a href="#" class="img-zoom"> <img src="../assets/images/ad-banner-4.jpg" alt=""
                              class=" rounded"></a>
                     ...
                     <div class="col">
                        <div class="card border-0">
                           <a href="#" class="img-zoom"> <img src="../assets/images/ad-banner-5.jpg" alt=""
                              class=" rounded"></a>
                     ...
                     <div class="col">
                        <div class="card border-0">
                           <a href="#" class="img-zoom"><img src="../assets/images/ad-banner-6.jpg" alt=""
                              class=" rounded"></a>
               ...
               <div class="row row-cols-1 row-cols-lg-3 row-cols-md-3 g-4 g-lg-4">
                  ...
                  <div class="col">
                     ...
                     <div class="card p-6 card-product">
                        <div>
                           <!-- img --><img src="../assets/images/stores-logo-1.svg" alt=""
  ...
  <div class="container">
    <div class="row align-items-center ">
        <div class="col-8 col-md-12 col-lg-4">
            <a href="#"><img src="../assets/images/freshcart-white-logo.svg" alt=""></a>
        </div>
...
<!-- Mirrored from freshcart.codescandy.com/pages/index-4.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:24 GMT -->
</html>