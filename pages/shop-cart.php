...
<!-- Mirrored from freshcart.codescandy.com/pages/shop-cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 Mar 2023 10:10:29 GMT -->
<head>
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item py-3 py-lg-0 px-0 border-top">
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-4 col-md-5">
                    <!-- title -->
                    <a href="shop-single.php" class="text-inherit"><h6 class="mb-0">Haldiram's Sev Bhujia</h6></a>
                    <span><small class="text-muted">.98 / lb</small></span>
                    <!-- text -->
                    <div class="mt-2 small lh-1"> <a href="#!" class="text-decoration-none text-inherit"> <span
                          class="me-1 align-text-bottom">
              ...
              <li class="list-group-item py-3 py-lg-0 px-0">
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-4 col-md-5">
                    <!-- title -->
                    <a href="shop-single.php" class="text-inherit"><h6 class="mb-0">NutriChoice Digestive </h6></a>
                    <span><small class="text-muted">250g</small></span>
                    <!-- text -->
                        <div class="mt-2 small lh-1"> <a href="#!" class="text-decoration-none text-inherit"> <span
                          class="me-1 align-text-bottom">
              ...
              <li class="list-group-item py-3 py-lg-0 px-0">
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-4 col-md-5">
                    <!-- title -->
                    <a href="shop-single.php" class="text-inherit"><h6 class="mb-0">Cadbury 5 Star Chocolate</h6></a>
                    <span><small class="text-muted">1 kg</small></span>
                    <!-- text -->
                        <div class="mt-2 small lh-1"> <a href="#!" class="text-decoration-none text-inherit"> <span
                          class="me-1 align-text-bottom">
              ...
              <li class="list-group-item py-3 py-lg-0 px-0">
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-4 col-md-5">
                    <!-- title -->
                    <a href="shop-single.php" class="text-inherit">  <h6 class="mb-0">Onion Flavour Potato</h6></a>
                    <span><small class="text-muted">250g</small></span>
                    <!-- text -->
                        <div class="mt-2 small lh-1"> <a href="#!" class="text-decoration-none text-inherit"> <span
                          class="me-1 align-text-bottom">
              ...
              <li class="list-group-item py-3 py-lg-0 px-0 border-bottom">
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-4 col-md-5">
                    <!-- title -->
                    <a href="shop-single.php" class="text-inherit"><h6 class="mb-0">Salted Instant Popcorn </h6></a>
                    <span><small class="text-muted">100g</small></span>
                    <!-- text -->
                        <div class="mt-2 small lh-1"> <a href="#!" class="text-decoration-none text-inherit"> <span
                          class="me-1 align-text-bottom">
